...
export default function AuthenticatedLayout({ header, children }: AuthenticatedLayoutProps) {
    ...
    const { auth, currentOrganization } = usePage().props as PageProps;
                            ...
                            <div className="ms-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link href={route('organizations.index')}>Organizations</Dropdown.Link>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink href={route('organizations.index')}>Organizations</ResponsiveNavLink>
